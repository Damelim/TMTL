...
load(paste('../clr_data_donor_nofiltered_2500hvg1.Rdata',sep=""))
X1 = X ; Y1 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg2.Rdata',sep=""))
X2 = X ; Y2 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg3.Rdata',sep=""))
X3 = X ; Y3 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg4.Rdata',sep=""))
X4 = X ; Y4 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg5.Rdata',sep=""))
X5 = X ; Y5 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg6.Rdata',sep=""))
X6 = X ; Y6 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg7.Rdata',sep=""))
X7 = X ; Y7 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg8.Rdata',sep=""))
X8 = X ; Y8 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg9.Rdata',sep=""))
X9 = X ; Y9 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg10.Rdata',sep=""))
X10 = X ; Y10 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg11.Rdata',sep=""))
X11 = X ; Y11 = as.matrix(Y)
load(paste('../clr_data_donor_nofiltered_2500hvg12.Rdata',sep=""))
...
for(j in 1:nrep){
  ...
  #### this part changes ####
  X0_split_data = center_XY(split_data(X12, Y12, train_prop, val_prop, test_prop))
  X1_split_data = center_XY(split_data(X1, Y1, train_prop, val_prop, test_prop))
  X2_split_data = center_XY(split_data(X2, Y2, train_prop, val_prop, test_prop))
  X3_split_data = center_XY(split_data(X3, Y3, train_prop, val_prop, test_prop))
  X4_split_data = center_XY(split_data(X4, Y4, train_prop, val_prop, test_prop))
  X5_split_data = center_XY(split_data(X5, Y5, train_prop, val_prop, test_prop))
  X6_split_data = center_XY(split_data(X6, Y6, train_prop, val_prop, test_prop))
  X7_split_data = center_XY(split_data(X7, Y7, train_prop, val_prop, test_prop))
  X8_split_data = center_XY(split_data(X8, Y8, train_prop, val_prop, test_prop))
  X9_split_data = center_XY(split_data(X9, Y9, train_prop, val_prop, test_prop))
  X10_split_data = center_XY(split_data(X10, Y10, train_prop, val_prop, test_prop))
  X11_split_data = center_XY(split_data(X11, Y11, train_prop, val_prop, test_prop))
  ####  ####
