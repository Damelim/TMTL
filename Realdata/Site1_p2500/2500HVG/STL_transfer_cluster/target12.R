...
X1 = X ; Y1 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg2.Rdata')
X2 = X ; Y2 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg3.Rdata')
X3 = X ; Y3 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg4.Rdata')
X4 = X ; Y4 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg5.Rdata')
X5 = X ; Y5 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg6.Rdata')
X6 = X ; Y6 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg7.Rdata')
X7 = X ; Y7 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg8.Rdata')
X8 = X ; Y8 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg9.Rdata')
X9 = X ; Y9 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg10.Rdata')
X10 = X ; Y10 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg11.Rdata')
X11 = X ; Y11 = Y %>% as.matrix()
load('../clr_data_donor_nofiltered_2500hvg12.Rdata')
